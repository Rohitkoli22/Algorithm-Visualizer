...
class APP:
    ...
    def init_gui(self):
        ...
        self.canvas.create_text(
            135.0, 573.5,
            text="Developed by : TYIF-G16",
            fill="#ffffff",
            font=("OxygenMono-Regular", int(12.0)))

        self.canvas.create_text(
            567.5, 571.0,
            text="SVERI'S College Of Engineering Polytechnique, Pandharpur",
            fill="#ffffff",
        ...
        self.speed_menu = ttk.Combobox(self.window, textvariable=self.speed_name, values=self.speed_list, state="readonly")
        ...
        self.algo_menu = ttk.Combobox(self.window, textvariable=self.algorithm_name, values=self.algo_list, state="readonly")
    ...
    def input(self):
        self.data=[]
        UserInput = simpledialog.askstring(title="User Input",prompt="Enter numbers :")
